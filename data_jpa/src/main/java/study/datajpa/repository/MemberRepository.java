...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom, JpaSpecificationExecutor {
    ...
    //@EntityGraph(attributePaths = {"team"}) // 기본 사용
    @EntityGraph("Member.all")  // @NamedEntityGraph를 사용하는 경우
    ...
    @Query(value = "select m from Member m where username = ? ", nativeQuery = true)
